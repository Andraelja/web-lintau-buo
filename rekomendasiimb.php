...
<body>
    <div class="content">
        ...
        <table width="500" border="1">
            <h1>Persyaratan</h1>
            <tr>
                <th colspan="100%" scope="col" bgcolor="blue">REKOMENDASI IMD</th>
            <tr>
            ...
            <tr>
                <td bgcolor="green">fotocopy sertifikat tanah / surat
                    keterangan tanah</td>
            </tr>

            <tr>
                <td bgcolor="green">surat keterangan prsetujuan jihad / sepadan</td>
            </tr>

            <tr>
                <td bgcolor="green">gambar situasi/gambar detaip(teknik)</td>
            </tr>
        </table>
    </div>

...
<head>
    ...
    <style>
        body {
            background: url(assets/img/pasabuo.jpg);
            display: flex;
...
<body>
    ...
    <table class="responsive-table" border="1">
        <tr>
            <th colspan="90%" scope="col">Data Nagari Buo</th>
        <tr>

        <tr>
            <th rowspan="90%" scope="row"><img src="./assets/img/buo.jpg" alt=""></th>
        <tr>
            <td>Kode Nagari : 01 <br>
                Kode Kemendagri : 13.04.06.2003 <br>
                Luas Wilayah : 80,95 km^2 <br>
                Jumlah Penduduk : 6.208 jiwa <br>
                Website : <a href="http://www.buo.desa.id/">http://www.buo.desa.id/</a>

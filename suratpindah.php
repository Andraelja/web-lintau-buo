...
<body>
    <div class="content">
        ...
        <table width="500" border="1">
            <h1>Persyaratan</h1>
            <tr>
                <th colspan="100%" scope="col" bgcolor="blue">Surat Pindah Penduduk</th>
            <tr>
                <td bgcolor="green">mengisi blangko f1.06 dan ditandatangani oleh walinagari</td>
            </tr>

            <tr>
                <td bgcolor="green">melampirkan kk asli dan fotocopy </td>
            </tr>

            <tr>
                <td bgcolor="green">melampirkan e-ktp asli dan fotocopy</td>
            </tr>

            <tr>
                <td bgcolor="green">paspoto warna 1 lembar 3x4</td>
            </tr>
        </table>
    </div>

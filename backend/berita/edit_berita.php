    ...
    if($tipe_file == "image/jpeg" || $tipe_file == "image/png"){
        ...
        if($ukuran_file <= 10000000){
            ...
            if(move_uploaded_file($tmp_file, $path)){
                ...
                $sql = mysqli_query($koneksi, "UPDATE `berita` SET `admin`='$admin',`judul`='$judul',`content`='$content',`tgl`='$tgl' ,`comment`='$comment' , `link`='$link',`deskripsi`='$deskripsi', `foto`='$nama_file'WHERE id='$id'");

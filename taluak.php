...
<head>
    ...
    <style>
        body {
            background: url(assets/img/talago.jpg);
        ...
        #content {
            /* Set margin to give space for the footer */
            margin-bottom: 50px;
        }
...
<body>
    ...
    <table class="responsive-table" border="1">
        <tr>
            <th colspan="90%" scope="col">Data Nagari Taluak</th>
        <tr>

        <tr>
            <th rowspan="90%" scope="row"><img src="./assets/img/taluak.jpg" alt=""></th>
        <tr>
            <td>Kode Nagari : 03 <br>
                Kode Kemendagri : 13.04.06.2001 <br>
                Luas Wilayah : 22,50 km^2 <br>
                Jumlah Penduduk : 7.629 jiwa <br>
                Website : -

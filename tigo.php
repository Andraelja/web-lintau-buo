...
<head>
    ...
    <title>Tigo Jangko</title>
    <style>
        body {
            background: url(assets/img/psdku.jpg);
...
<body>
    ...
    <table class="responsive-table" border="1">
        <tr>
            <th colspan="90%" scope="col">Data Nagari Tigo Jangko</th>
        <tr>

        <tr>
            <th rowspan="90%" scope="row"><img src="./assets/img/tigo jangko.jpg" alt=""></th>
        <tr>
            <td>Kode Nagari : 02 <br>
                Kode Kemendagri : 13.04.06.2002 <br>
                Luas Wilayah : 8,53 km^2 <br>
                Jumlah Penduduk : 1.632 jiwa <br>
                Website : <a href="http://www.tigojangko.desa.id/">http://www.tigojangko.desa.id/</a>
